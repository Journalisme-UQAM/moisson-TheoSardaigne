...
### Oh là là... Ton script est un copié-collé de ce que je vous ai déjà remis...
### Auquel il manque en outre des éléments (le fichier «accesstwit» n'est pas là...)
### Tu as ajouté plusieurs commentaires, ce qui est très bien, mais pas suffisant.
### Et puis, ton script ne génère pas de CSV...
### Malheureusement, l'effort n'est pas là...
